...
def get_model(model_name, dataset_name, pc, num_classes, kernel_size, ps, k, group_num, emb_dim):
    if model_name == 'DSFormer':
        ...
        model = MSS_MambaNet(in_channel=pc, embed_dim=64, img_size=ps, num_classes=num_classes)
    else:

...
def train(network, optimizer, criterion, criterion2, train_loader, val_loader, epoch, saving_path, device, scheduler=None):
    ...
    for e in tqdm(range(1, epoch+1), desc=""):
        ...
        for batch_idx, (images, targets) in enumerate(train_loader):
            ...
            loss2 = criterion2(outputs[1], images.squeeze())
